...
```
@SpringBootApplication注解集成了@EnableAutoConfiguration
...
其中@Import({AutoConfigurationImportSelector.class}),引入了AutoConfigurationImportSelector
...
表示的意思为：如果存在名称为rabbitListenerContainerFactory的bean，则该部分代码直接忽略
